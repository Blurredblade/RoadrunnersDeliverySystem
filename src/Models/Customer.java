...
public class Customer {
    ...
    public SimpleBooleanProperty customerStatus = new SimpleBooleanProperty();
    public Integer getCustomerID() { return customerID.get(); }
    public String getCustomerName() { return customerName.get(); }
    public String getCustomerLoc() { return customerLoc.get(); }
    public Boolean getCustomerStatus() { return customerStatus.get(); }
    public void test() { System.out.println("Customer ID: " + customerID + " NAME: "
            + customerName + " LOCATION: " + customerLoc + " Active: " + customerStatus  ); }
}
